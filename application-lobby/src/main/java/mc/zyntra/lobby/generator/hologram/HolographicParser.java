...
public class HolographicParser implements Listener {
    ...
    public HolographicParser() {
        ...
        how_to_play = new Hologram(location.clone().add(0, 0.5, 0), Arrays.asList("§b'§b§lCOMO JOGAR?§b'", "§ePara iniciar sua jogatina,", "§ebasta clicar no NPC do", "§emodo de jogo desejado!"));
