package mc.zyntra.server.system.utils;
...
public enum StringFormat {
    ...
    private StringFormat(char character, int length) {
    ...
    public static StringFormat getDefaultFontInfo(char c){
        for(StringFormat dFI : values()){
    ...
    public static String makeCenteredMotd(String message) {
        ...
        for (int j = 0; j < i; j++) {
            ...
            if (c == '§') {
                ...
                StringFormat dFI = getDefaultFontInfo(c);
