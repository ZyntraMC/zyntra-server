...
public class ServerCommandContext implements CommandContext {

    private final CommandSender sender;
    private final String[] args;
    private final String commandLabel;

    public ServerCommandContext(final CommandSender sender, final String[] args, final String commandLabel, final int subCommand) {
