...
public final class ServerCompleter implements Listener {
    ...
    public ServerCompleter(final Method method, final String label, final CommandClass commandObject, final Plugin plugin) {
        this.method = method;
        this.label = label;
    ...
    public void onTab(final TabCompleteEvent e) {
        try {
            ...
            final CommandContext commandContext = new ServerCommandContext((CommandSender) e.getSender(), finalArgs, label, label.split("\\.").length - 1);
