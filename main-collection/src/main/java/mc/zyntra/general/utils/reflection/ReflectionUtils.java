package mc.zyntra.general.utils.reflection;
...
public final class ReflectionUtils {
    ...
    /**
     * Sends a packet to the player's client through a {@code SubServerManager} which
    ...
    static {
        ...
        try {
            ...
            sendPacket = lookup.findVirtual(playerConnection,
                    v(18, "br/com/nordmc/core").orElse("sendPacket"),
    ...
    public static void removePrivate(Field field) throws Exception {
        Field modifiersField = Field.class.getDeclaredField("modifiers");
        modifiersField.setAccessible(true);
