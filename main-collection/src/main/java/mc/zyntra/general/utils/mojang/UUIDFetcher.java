...
public class UUIDFetcher {
	...
	private static final List<String> apis = new ArrayList<>();

	private static final LoadingCache<String, UUID> cache = CacheBuilder.newBuilder().expireAfterAccess(10L, TimeUnit.MINUTES)
